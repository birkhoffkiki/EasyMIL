...
data_root_dir="/jhcnas3/Pathology/Patches/CPTAC__BRCA"
log_dir="eval_scripts/logs/CPTAC-BRCA_survival_"
study="BRCA"
...
do
    ...
    do
        ...
        exp=$model"/"$backbone
        echo "processing:"$exp
        model_exp_code="TCGA_"$study"_survival/"$model"/"$backbone"_s1"  # default seed is 1  
