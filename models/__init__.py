...
__implemented_models = {
    ...
    'mae_vit_large_patch16-1-40000': 'models/ckpts/checkpoint-1-40000.pth',
    'mae_vit_large_patch16-1-140000': 'models/ckpts/checkpoint-1-140000.pth',
    'mae_vit_large_patch16-1epoch-180M': 'models/ckpts/checkpoint-1epoch-180M-patches.pth',
    'ctranspath': 'models/ckpts/ctranspath.pth',
    'mae_vit_l_1000slides_19epoch': 'models/ckpts/mae_vit_l_1000slides_19epoch.pth',
    'mae_vit_l_10000slides_3epoch': 'models/ckpts/mae_vit_l_10000slides_3epoch.pth',
    ...
    'distill_379999_cls_only': 'models/ckpts/distill_349999_cls_only.pth',
    'distill_487499_cls_only': 'models/ckpts/distill_487499_cls_only.pth',
    'phikon': 'sota'
}
