...
def generate_splits(csv_path, output_dir):
    ...
    for i in range(5):
        ...
        train_ids = data['ID'][data[fold_col] == 'train'].tolist()
        val_ids = data['ID'][data[fold_col] == 'val'].tolist()
...
csv_path = '/storage/Pathology/codes/EasyMIL/dataset_csv/survival_by_case/GBMLGG_Splits.csv'
output_dir = '/storage/Pathology/codes/EasyMIL/splits82/TCGA_GBMLGG_survival_100'
