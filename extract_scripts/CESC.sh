...
ramdisk_cache="/home/gzr/tmp/cesc"

DIR_TO_COORDS="/storage/Pathology/Patches/TCGA__CESC"
DATA_DIRECTORY="/jhcnas3/Pathology/original_data/TCGA/CESC"
CSV_FILE_NAME="/storage/Pathology/codes/CLAM/dataset_csv/CESC.csv"
FEATURES_DIRECTORY="/storage/Pathology/Patches/TCGA__CESC"
ext=".svs"
save_storage="yes"
