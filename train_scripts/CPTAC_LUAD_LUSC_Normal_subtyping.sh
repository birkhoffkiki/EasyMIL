...
gpus['96_hat_encoder_512_512_nomem']=3 #√
gpus['hat_encoder_256_32_nomem']=6 #√
gpus["moe"]=3



root_log="/storage/Pathology/codes/EasyMIL/train_scripts/logs/train_log_CPTAC_LUAD_LSCC_Normal_"
task="CPTAC_LUAD_LSCC_Normal"
